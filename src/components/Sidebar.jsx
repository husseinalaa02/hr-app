...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: '/recruitment', label: 'Recruitment', permission: 'recruitment:read',
      ...
      {
        to: '/appraisals', label: 'Appraisals', permission: 'appraisals:read',
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: '/timesheets', label: 'Timesheets', permission: 'timesheets:read',
      ...
      {
        to: '/leave', label: 'Leave Requests', permission: 'leave:read',
      ...
      {
        to: '/day-requests', label: 'Day Requests', permission: 'day_requests:read',
  ...
  },
  {
    ...
    items: [
      {
        to: '/payroll', label: 'Payroll', permission: 'payroll:read',
      ...
      {
        to: '/payslips', label: 'Payslips', permission: 'payslips:read',
      ...
      {
        to: '/reports', label: 'Reports', permission: '__reports__',
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: '/admin', label: 'Control Panel', permission: '__admin__',
...
const ROLE_LABELS = {
  admin: 'Administrator', ceo: 'CEO', hr_manager: 'HR Manager',
